<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true"
    CodeFile="ISSolutionList.aspx.cs" Inherits="AdminPanel_ISSolutionList" %>
                ...
                <div class="portlet-body form">
                    <div role="form">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtInvoiceNo" CssClass="form-control" runat="server" PlaceHolder="Enter Invoice No"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtPONo" CssClass="form-control" runat="server" PlaceHolder="Enter PO No."></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="dptDate" CssClass="form-control" runat="server" PlaceHolder="Enter Date"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="dptPODate" CssClass="form-control" runat="server" PlaceHolder="Enter PO Date"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-9">
                                    <asp:Button ID="btnSearch" SkinID="btnSearch" runat="server" Text="Search"  />
                                    <%--OnClick="btnSearch_Click"   OnClick="btnClear_Click"--%>
                                    <asp:Button ID="btnClear" runat="server" SkinID="btnClear" Text="Clear"  />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    <asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/ISSolution.aspx"
                                    ...
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th>
                                                        <asp:Label ID="lbhInvoiceNo" runat="server" Text="Invoice No"></asp:Label>
                                                    </th>
                                                    <th class="text-center">
                                                        <asp:Label ID="lbhDate" runat="server" Text="Date"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhPONo" runat="server" Text="PO No"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhPODate" runat="server" Text="PO Date"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <asp:HyperLink ID="hlViewExpenseID" runat="server"><%#Eval("InvoiceNo") %></asp:HyperLink>
                                                            </td>
                                                            ...
                                                            <td class="text-center">
                                                                <%#Eval("PODate", GNForm3C.CV.DefaultDateFormatForGrid) %>
                                                            </td>
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/ISSolution.aspx?PurchaseInvoiceID=" + Eval("PurchaseInvoiceID").ToString() %>'
                                                                    runat="server"></asp:HyperLink>
