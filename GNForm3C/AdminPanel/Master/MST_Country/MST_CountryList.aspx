<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true"
    CodeFile="MST_CountryList.aspx.cs" Inherits="AdminPanel_Master_MST_Country_MST_CountryList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="LabelCountryName" runat="server" Text="Country"></asp:Label>
    </li>
</asp:Content>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtCountryCode" CssClass="First form-control" runat="server" PlaceHolder="Enter Country Code"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    ...
                                    <%----%>
                                    <asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Master/MST_Country/MST_CountryAddEdit.aspx"
                                        runat="server"></asp:HyperLink>
                                    <asp:HyperLink SkinID="hlAddMany" ID="h1AddMany" NavigateUrl="~/AdminPanel/Master/MST_Country/MST_CountryAddMany.aspx"
                                        runat="server"></asp:HyperLink>
                                                ...
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="hflCountryName" Text='<%#Eval("CountryName")%>' runat="server"
                                                                    NavigateUrl='<%# "~/AdminPanel/Master/MST_State/MST_StateAddEdit.aspx?CountryID=" + Eval("CountryID")%>'></asp:HyperLink>
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                ...
                                                                <asp:HyperLink ID="hlView" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Master/MST_Country/MST_CountryView.aspx?CountryID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("CountryID").ToString()) %>'
                                                                ...
                                                                <asp:HyperLink ID="AddData" title="Edit Record" runat="server" Text="Edit" CssClass="btn btn-xs btn-circle blue-soft tooltips"
                                                                    ...
                                                                    NavigateUrl='<%# "~/AdminPanel/Master/MST_Country/MST_CountryAddEdit.aspx?CountryID=" + Eval("CountryID")%>'>  <i class="fa fa-edit"></i> </asp:HyperLink>
