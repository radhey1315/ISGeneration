<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="MST_HospitalList.aspx.cs" Inherits="AdminPanel_MST_Hospital_MST_HospitalList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
	<asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="Shop"></asp:Label>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="Shop"></asp:Label>
    </li>
</asp:Content>
								...
								<div class="col-md-4">
									<div class="form-group">
										<div class="input-group">
											...
											<asp:TextBox ID="txtHospital" CssClass="First form-control" runat="server"  PlaceHolder="Enter Shop"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th><asp:Label ID="lbhHospital" runat="server" Text="Shop"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhPrintName" runat="server" Text="Print Name"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhPrintLine1" runat="server" Text="Print Line1"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhPrintLine2" runat="server" Text="Print Line2"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhPrintLine3" runat="server" Text="Print Line3"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhFooterName" runat="server" Text="Footer Name"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhReportHeaderName" runat="server" Text="Report Header Name"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lblExpenseTypeCount" runat="server" Text="Expense Type Count"></asp:Label>
                                                    </th>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="text-center">
                                                                <asp:HyperLink Text='<%#Eval("ExpenseTypeCount") %>' SkinID="hlGreen_Grid"  ID="hlCount" NavigateUrl='<%# "~/AdminPanel/Master/MST_ExpenseType/MST_ExpenseTypeList.aspx?HospitalID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("HospitalID").ToString()) %>' runat="server"></asp:HyperLink>
                                                                <%--<asp:Label ID="lblExpenseTypeCount" runat="server" SkinID="lblShowCount" Text='<%#Eval("ExpenseTypeCount") %>'></asp:Label>--%>
                                                                <asp:HyperLink ID="hlEditCount" Visible="true" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Master/MST_ExpenseType/MST_ExpenseTypeAddMany.aspx?HospitalID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("HospitalID").ToString()) %>'  runat="server"></asp:HyperLink>
                                                            	<%--<%#Eval("ExpenseTypeCount") %>--%>
                                                            </td>
