...
public partial class AdminPanel_MST_Hospital_MST_HospitalList : System.Web.UI.Page
{ 
    ...
    private void Search(int PageNo)
    {
        ...
        if (dt != null && dt.Rows.Count > 0)
        {
            ...
            {
                HyperLink hlCount = (HyperLink)Ri.FindControl("hlCount");
                HyperLink hlEditCount = (HyperLink)Ri.FindControl("hlEditCount");

                if (Convert.ToInt32(hlCount.Text.Trim()) == 0)
                {
                    hlEditCount.Visible = false;
                    hlCount.NavigateUrl = "";
                }
