<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true"
    CodeFile="EmployeeList.aspx.cs" Inherits="AdminPanel_Master_MST_Employee_EmployeeList" %>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtEmployeeCode" CssClass="First form-control" runat="server" PlaceHolder="Enter Employee Code"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                           ...
                                           <asp:DropDownList ID="ddlDepartmentName" CssClass="form-control select2me" runat="server" AutoPostBack="true" ></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    ...
                                    <asp:LinkButton SkinID="hlDeleteMany" runat="server" ID="btnDeleteMany" OnClientClick="javascript:return confirm('Are you sure you want to delete record ? ');"
                                        OnClick="lbtnDelete_Click"></asp:LinkButton>
                                    <asp:HyperLink SkinID="hlAddMany" ID="h1AddMany" NavigateUrl="~/AdminPanel/Master/MST_Employee/EmployeeAddMany.aspx"
                                        runat="server"></asp:HyperLink>

                                    <asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Master/MST_Employee/EmployeeAddEdit.aspx"
                                        runat="server"></asp:HyperLink>
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    ...
                                                    <th class="nosortsearch text-nowrap text-center">
                                                        <asp:Label ID="lbhHobby" runat="server" Text="Hobbies"></asp:Label>
                                                    </th>
                                                ...
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="hflEmployeeName" Text='<%#Eval("EmpName")%>' Value='<%#Eval("EmployeeID")%>'
                                                                    runat="server"
                                                                    NavigateUrl='<%# "~/AdminPanel/Master/MST_Employee/EmployeeView.aspx?EmployeeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("EmployeeID").ToString()) %>'
                                                                    data-target="#viewiFrameReg" CssClass="modalButton" data-toggle="modal"></asp:HyperLink>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:HiddenField runat="server" ID="hfDepartmentID" Value='<%#Eval("DepartmentID") %>'
                                                                    Visible="false" />
                                                                <%#Eval("DepartmentName") %>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                ...
                                                                <asp:HyperLink ID="hlView" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Master/MST_Employee/EmployeeView.aspx?EmployeeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("EmployeeID").ToString()) %>'
                                                                ...
                                                                <asp:HyperLink ID="AddData" title="Edit Record" runat="server" Text="Edit" CssClass="btn btn-xs btn-circle blue-soft tooltips"
                                                                    ...
                                                                    NavigateUrl='<%# "~/AdminPanel/Master/MST_Employee/EmployeeAddEdit.aspx?EmployeeID=" + Eval("EmployeeID")%>'>  <i class="fa fa-edit"></i> </asp:HyperLink>
