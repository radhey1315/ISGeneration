                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                 <div>
                                     <asp:HyperLink SkinID="hlAddMore" ID="hlAddEditMore" NavigateUrl="~/AdminPanel/Master/MST_ExpenseType/MST_ExpenseTypeAddEditMore.aspx" runat="server"></asp:HyperLink>
									<asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Master/MST_ExpenseType/MST_ExpenseTypeAddEdit.aspx" runat="server"></asp:HyperLink>
                                     <asp:HyperLink SkinID="hlAddMany" ID="h1AddMany" NavigateUrl="~/AdminPanel/Master/MST_ExpenseType/MST_ExpenseTypeAddMany.aspx" runat="server"></asp:HyperLink>
                                ...
                                <div class="col-md-12">
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th><asp:Label ID="lbhExpenseType" runat="server" Text="Expense Type"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhHospitalID" runat="server" Text="Shops"></asp:Label>
                                                    </th>
