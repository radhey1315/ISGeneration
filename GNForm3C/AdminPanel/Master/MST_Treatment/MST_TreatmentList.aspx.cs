...
public partial class AdminPanel_MST_Treatment_MST_TreatmentList : System.Web.UI.Page
{ 
    #region 11.0 Variables
	
    String FormName = "MST_TreatmentList";
    ...
    private void Search(int PageNo)
    {
        ...
        SqlString Treatment = SqlString.Null;
    ...
    protected void rpData_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "DeleteRecord")
        {
            try
            {
                ...
                {                    
                    if (balMST_Treatment.Delete(Convert.ToInt32(e.CommandArgument)))
                    {
	...
	if (ViewState["CurrentPage"] != null)
        ...
        MST_TreatmentBAL balMST_Treatment = new MST_TreatmentBAL();
        DataTable dtMST_Treatment = balMST_Treatment.SelectPage(Offset, PageRecordSize, out TotalReceivedRecord, Treatment, HospitalID);
        if (dtMST_Treatment != null && dtMST_Treatment.Rows.Count > 0)
		{
            Session["ExportTable"] = dtMST_Treatment;
