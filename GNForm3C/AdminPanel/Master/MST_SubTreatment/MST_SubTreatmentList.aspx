<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="MST_SubTreatmentList.aspx.cs" Inherits="AdminPanel_MST_SubTreatment_MST_SubTreatmentList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
    <asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="Sub Treatment"></asp:Label>
    <small>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="SubTreatment"></asp:Label>
    </li>
</asp:Content>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtSubTreatmentName" CssClass="First form-control" runat="server" PlaceHolder="Enter Sub Treatment Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtSequenceNo" CssClass="form-control" runat="server" PlaceHolder="Enter Sequence No"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    <asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Master/MST_SubTreatment/MST_SubTreatmentAddEdit.aspx" runat="server"></asp:HyperLink>
                                    ...
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th>
                                                        <asp:Label ID="lbhSubTreatmentName" runat="server" Text="Sub Treatment Name"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhSequenceNo" runat="server" Text="Sequence No"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhRate" runat="server" Text="Rate"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhIsInGrid" runat="server" Text="Is In Gr"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhHospitalID" runat="server" Text="Shop"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhIsPerDay" runat="server" Text="Is Per Day"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhDefaultUnit" runat="server" Text="Default Unit"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <asp:HyperLink ID="hlViewSubTreatmentID" NavigateUrl='<%# "~/AdminPanel/Master/MST_SubTreatment/MST_SubTreatmentView.aspx?SubTreatmentID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("SubTreatmentID").ToString()) %>' data-target="#viewiFrameReg" CssClass="modalButton" data-toggle="modal" runat="server"><%#Eval("SubTreatmentName") %></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                                <%#Eval("SequenceNo") %>
                                                            </td>
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink ID="hlView" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Master/MST_SubTreatment/MST_SubTreatmentView.aspx?SubTreatmentID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("SubTreatmentID").ToString()) %>' data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
                                                                <asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Master/MST_SubTreatment/MST_SubTreatmentAddEdit.aspx?SubTreatmentID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("SubTreatmentID").ToString()) %>' runat="server"></asp:HyperLink>
                                                                <asp:LinkButton ID="lbtnDelete" runat="server"
                                                                    SkinID="Delete"
                                                                    OnClientClick="javascript:return confirm('Are you sure you want to delete record ? ');"
                                                                    CommandName="DeleteRecord"
                                                                    CommandArgument='<%#Eval("SubTreatmentID") %>'>
                                                                </asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                        <%-- END Table Rows --%>
