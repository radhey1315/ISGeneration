                                        ...
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    ...
                                                    <th class="text-center"><asp:Label ID="lbhSerialNo" runat="server" Text="Serial No"></asp:Label>
                                                    </th>
                                                    ...
                                                    <th class="text-right"><asp:Label ID="lbhReceiptNo" runat="server" Text="Receipt No"></asp:Label>
                                                    </th>
                                                ...
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="text-right">
                                                            	<%#Eval("ReceiptNo", GNForm3C.CV.DefaultCurrencyFormatWithDecimalPoint) %>
                                                            </td>
