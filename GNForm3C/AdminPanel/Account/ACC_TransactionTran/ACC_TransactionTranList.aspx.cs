...
{ 
    ...
    private void Search(int PageNo)
    {
        ...
        DataTable dt = balACC_TransactionTran.SelectPage(Offset, PageRecordSize, out TotalRecords, Patient);
	...
	if (ViewState["CurrentPage"] != null)
        ...
        ACC_TransactionTranBAL balACC_TransactionTran = new ACC_TransactionTranBAL();
        DataTable dtACC_TransactionTran = balACC_TransactionTran.SelectPage(Offset, PageRecordSize, out TotalReceivedRecord, Patient);
